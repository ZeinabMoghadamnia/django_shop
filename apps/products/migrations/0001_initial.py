# Generated by Django 4.2.7 on 2024-01-14 10:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount_type', models.CharField(choices=[('percentage', 'Percent'), ('amount', 'Amount')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='user_who_liked', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
