# Generated by Django 4.2.7 on 2024-01-31 11:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('restored_at', models.DateTimeField(blank=True, null=True, verbose_name='date restored')),
                ('is_active', models.BooleanField(default=True, verbose_name='active status')),
                ('status', models.CharField(choices=[('approved', 'approved'), ('waiting', 'waiting'), ('rejected', 'rejected')], default='waiting', max_length=10, verbose_name='verify_status')),
