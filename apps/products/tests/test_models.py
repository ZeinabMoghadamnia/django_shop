...
class DiscountTestCase(TestCase):
    def setUp(self):
        self.discount_percentage = Discount.objects.create(code='Test DiscountP', discount_type='percentage', value=10,
                                                           slug='test-discountp')
        self.discount_amount = Discount.objects.create(code='Test DiscountA', discount_type='amount',
                                                       value=100, slug = 'test-discounta')
        ...
        def test_discount_p_model(self):
            ...
            self.assertEqual(discount.slug, 'test-discountp')
        ...
        def test_discount_a_model(self):
            ...
            self.assertEqual(discount.slug, 'test-discounta')
    ...
    class BrandTestCase(TestCase):
        ...
        def test_brand_model(self):
            ...
            self.assertEqual(brand.image, None)
    ...
    class CategoryTestCase(TestCase):
        ...
        def test_category_model(self):
            ...
            self.assertEqual(category.parent, 'Parent Category')
            self.assertEqual(category.image, None)
