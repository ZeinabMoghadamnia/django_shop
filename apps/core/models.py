...
class BaseModel(models.Model):
    ...
    deleted_at = models.DateTimeField(blank=True, null=True, verbose_name=_('date deleted'))
    restored_at = models.DateTimeField(blank=True, null=True , verbose_name=_('date restored'))
