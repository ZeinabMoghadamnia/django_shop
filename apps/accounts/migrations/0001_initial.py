    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(blank=True, choices=[('costumer', 'Costumer'), ('manager', 'Manager'), ('supervisor', 'Supervisor'), ('operator', 'Operator')], max_length=20, null=True, verbose_name='user type')),
